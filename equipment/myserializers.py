...
class equipmentSerialzer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.data_PM2_5 = validated_data.get("data_PM2_5",instance.data_PM2_5)
        instance.data_PM10 = validated_data.get("data_PM10",instance.data_PM10)
        instance.data_O3 = validated_data.get("data_O3",instance.data_O3)
        instance.data_SO2 = validated_data.get("data_SO2",instance.data_SO2)
        instance.data_NO2 = validated_data.get("data_NO2",instance.data_NO2)
        instance.data_CO = validated_data.get("data_CO",instance.data_CO)
    ...
    def is_valid(self, raise_exception=False):
        super(equipmentSerialzer, self).is_valid()
        return True
