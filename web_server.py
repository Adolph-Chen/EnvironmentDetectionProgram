...
web_req_queue_parm, web_resp_queue_parm = Queue(), Queue()
            ...
            if msg_type == 'device_operations':
                ...
                for client in factory.clients:
                    ...
                    if client.group_code == group_code:
                        client.send(json.dumps(data))  #发回给dajngo
                        break
                    else:
                        log.msg('没有合适的网关')
            else:
...
startup(web_req_queue_parm, web_resp_queue_parm)